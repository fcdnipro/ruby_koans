...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # -------- ANS ----------
    # In case the "send" method is already defined as something else?
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # ---- ANS -----
    # Then you would not have the NoMethodError, as there would be a defined method?
  ...
  def test_all_messages_are_caught
    ...
    assert_equal "Someone called foobaz with <>", catcher.foobaz
